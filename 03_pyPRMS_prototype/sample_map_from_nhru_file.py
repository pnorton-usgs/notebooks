...
# workdir = '/Users/pnorton/Projects/National_Hydrology_Model/datasets/bandit/jobs/20170915_r13'
...
csv_file = '{}/nhru_out_{}.csv'.format(workdir, cblabel)
...
# %%
df_csv = pd.read_csv(csv_file, index_col=[0], parse_dates=True)
df_csv = df_csv[st_date:en_date]


df_csv.reset_index(drop=True, inplace=True)
df_csv.columns = df_csv.columns.astype(int)
...
ren_dict = {k + 1: v for k, v in enumerate(df_nhm['nhm_id'].tolist())}

# NOTE: The rename is an expensive operation
df_csv.rename(columns=ren_dict, inplace=True)
...
# %%
bb = df_csv.transpose()
bb.rename(columns={0: cblabel}, inplace=True)
bb.head()
