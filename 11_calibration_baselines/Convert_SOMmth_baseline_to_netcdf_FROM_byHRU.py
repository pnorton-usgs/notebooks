...
# ===============
# NHM v1.0 format
# YR  MTH   MIN     MAX    MERRA    NCEP-NCAR   MOSAIC     NOAH
...
the_vars = {'soil_moist_min_norm': {'standard_name': 'soil_moist_min_norm',
                                    'description': 'Normalized monthly minimum top-layer soil moisture',
                                    'datatype': 'f4',
                                    'units': 'fraction',
                                    'fill_value': nc.default_fillvals['f4']},
            'soil_moist_max_norm': {'standard_name': 'soil_moist_max_norm',
                                    'description': 'Normalized monthly maximum top-layer soil moisture',
                                    'datatype': 'f4',
                                    'units': 'fraction',
                                    'fill_value': nc.default_fillvals['f4']}}
...
outfile = f'{workdir}/{baseline}/baseline_SOMmth.nc'
