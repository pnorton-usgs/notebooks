...
# baselines.AETmod16
# baselines.AETmwbm
# baselines.AETrng   57 columns classed as int64
# baselines.AETssebop
...
# %%
var_info = {'AETmax': ['Maximum actual evapotranspiration', 'inch'], 
            'AETmin': ['Minimum actual evapotranspiration', 'inch'], 
            'AETmdr': ['Median actual evapotranspiration', 'inch'],
            'AETmean': ['Mean actual evapotranspiration', 'inch'],
            'AETrng' : ['Range of actual evapotranspiration', 'inch'],
            'AETmod16': ['Actual evapotranspiration from MODIS-16', 'inch'],
            'AETmwbm': ['Actual evapotranspiration from Monthly Water Balance Model', 'inch'],
            'AETssebop': ['Actual evapotranspiration from SSEBOP', 'inch']}

delim = {'AETmax': ',', 'AETmin': ',', 'AETmdr': ',', 'AETmean': ',', 'AETrng': ',',
         'AETmod16': ' ', 'AETmwbm': ' ', 'AETssebop': ' '}
