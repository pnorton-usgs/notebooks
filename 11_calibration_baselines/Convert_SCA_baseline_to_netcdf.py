...
# %%
var_info = {'SCA': ['Maximum recharge', 'fraction'], 
            'SCAci': ['Minimum recharge', 'fraction']}
...
df = pd.read_csv(filename, sep=delim[cvar], skipinitialspace=True,
                 date_parser=dparse, parse_dates={'date': [0, 1, 2]},
                 engine='c', memory_map=True, index_col='date', na_values=[-9.0, -9.99, -99.0, -99.99, -999.0, -9999.0])
