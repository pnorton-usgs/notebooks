...
# %%
baseline_var = 'SOM'
max_var_ann = f'{baseline_var}annMAX'
min_var_ann = f'{baseline_var}annMIN'
max_var_mth = f'{baseline_var}mthMAX'
min_var_mth = f'{baseline_var}mthMIN'
...
baseline_file_ann = f'{baseline_dir}/baselines_{baseline_var}ann.nc'
baseline_file_mth = f'{baseline_dir}/baselines_{baseline_var}mth.nc'
...
baseline_ann_df = baseline_ann_df[[max_var_ann, min_var_ann, 'hru']].sel(time=slice(st_date, en_date))

baseline_mth_df = xr.open_dataset(baseline_file_mth)
baseline_mth_df = baseline_mth_df[[max_var_mth, min_var_mth, 'hru']].sel(time=slice(st_date, en_date))
